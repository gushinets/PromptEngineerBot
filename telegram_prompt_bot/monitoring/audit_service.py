...
from telegram_prompt_bot.database.models import AuthEvent, get_db_session, mask_email, mask_telegram_id
...
class AuditService:
    ...
    def log_event(
        ...
        try:
            ...
            if email:
                from telegram_prompt_bot.database.models import normalize_email
