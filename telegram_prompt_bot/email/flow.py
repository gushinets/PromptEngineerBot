...
from telegram_prompt_bot.auth.service import get_auth_service
...
from telegram_prompt_bot.database.models import mask_email, mask_telegram_id
from telegram_prompt_bot.config.dependencies import get_container
from telegram_prompt_bot.email.service import get_email_service
...
from telegram_prompt_bot.infrastructure.redis_client import get_redis_client
    ...
    async def _proceed_to_followup_and_delivery(
        ...
        try:
            ...
            try:
                ...
                from telegram_prompt_bot.utils.graceful_degradation import ServiceType
