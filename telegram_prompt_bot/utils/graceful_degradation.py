...
from telegram_prompt_bot.infrastructure.health_checks import HealthStatus, get_health_monitor
from telegram_prompt_bot.monitoring.logging_utils import get_logger
...
class GracefulDegradationManager:
    ...
    def get_user_message(self, language: str = "EN") -> Optional[str]:
        ...
        from telegram_prompt_bot.email.templates import _
