...
class TestBotHandler:
    ...
    async def test_handle_followup_choice_yes(
        ...
        """Test handling ДА choice in follow-up questions."""
        user_id = mock_update.effective_user.id
        ...
        # Mock the start_followup_conversation method
        with patch.object(
            ...
            # Verify start_followup_conversation was called with cached prompt
            mock_start.assert_called_once_with(user_id, cached_prompt)
        ...
        # Verify LLM was called for initial follow-up questions
        bot_handler.llm_client.send_prompt.assert_called_once()
    ...
    async def test_complete_followup_workflow_yes_flow(
        ...
        # Step 4: User provides final answer and LLM returns refined prompt
