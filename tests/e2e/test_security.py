...
from telegram_bot.data.database import mask_email, mask_telegram_id, normalize_email
...
class TestOTPSecurity:
    ...
    def auth_service(self, mock_redis_client, mock_config):
        ...
        with patch(
            "telegram_bot.auth.auth_service.get_redis_client",
...
class TestDataProtectionSecurity:
    ...
    def test_database_data_protection(self):
        ...
        from telegram_bot.data.database import AuthEvent, User
