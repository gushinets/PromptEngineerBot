...
from telegram_bot.services.redis_client import RedisClient, get_redis_client, init_redis


@pytest.fixture
def mock_redis():
    """Mock Redis client for testing."""
    with patch("telegram_bot.services.redis_client.redis.Redis") as mock_redis_class:
        mock_client = Mock()
...
class TestGlobalRedisClient:
    ...
    def test_init_redis(self):
        ...
        importlib.reload(telegram_bot.services.redis_client)
