...
# from telegram_prompt_bot.email.flow import EmailFlowOrchestrator  # Mock this for testing
    ...
    async def mock_run_optimization_and_email_delivery(
        ...
        try:
            ...
            if email_failed:
                ...
                from telegram_prompt_bot.utils.messages import ERROR_EMAIL_OPTIMIZATION_FAILED
