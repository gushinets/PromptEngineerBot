...
# from telegram_prompt_bot.core.bot_handler import BotHandler  # Mock this for testing
...
def bot_handler(mock_config, mock_llm_client):
    ...
    with patch("telegram_prompt_bot.core.bot_handler.get_email_flow_orchestrator") as mock_get_flow:
