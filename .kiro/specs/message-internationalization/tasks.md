...
- [ ] 1. Create new message constants in messages.py
...
- [ ] 2. Update imports in bot_handler.py
...
- [ ] 3. Replace hardcoded strings in bot_handler.py
...
- [ ] 6. Run existing tests and fix any issues
...
- [ ] 7. Validate refactoring completion
